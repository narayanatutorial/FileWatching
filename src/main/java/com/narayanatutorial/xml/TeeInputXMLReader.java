package com.narayanatutorial.xml;
...
public final class TeeInputXMLReader {
     
    private static final String XML_PATH =
            "D:/localDownload/web.xml";
     
    private static final String INPUT = "This should go to the output.";
 
    public static void readOneFileWriteToOneFile() {
    ...
    public static void main(String args[]) {
    	TeeInputXMLReader.readOneFileWriteToOneFile();
    }
}
